...
export default function Hero() {
  ...
  return (
    <section className="relative hero-gradient noise overflow-hidden min-h-svh flex items-center">
      {/* Decorative orbs */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-32 md:py-40 w-full">
        ...
        <div>
          ...
          >
            Coordinamos tu mudanza, trasteo o acarreo en Pereira y Dosquebradas con operadores verificados.
            <span className="text-white font-medium"> Escríbenos y te cotizamos en minutos.</span>
          </p>
          ...
          >
            <Button variant="whatsapp" size="lg" href={getWhatsAppUrl('Hola, necesito cotizar una mudanza en Pereira')}>
          ...
          {/* Trust strip */}
          <div
            className={`flex flex-wrap gap-x-8 gap-y-3 transition-all duration-700 delay-900 ${
          ...
          >
            <img
              src="/mudanzas-pereira-cajas.png"
              alt="Cajas de mudanza y trasteo en Pereira listas para acarreo profesional"
