...
const servicePages = [
  {
    ...
    metaDescription: 'Mudanzas y trasteos económicos en Pereira. Servicio profesional a precios accesibles. Acarreos baratos. Cotización gratis por WhatsApp.',
    content: [
      'Sabemos que una mudanza o trasteo puede representar un gasto importante. Por eso ofrecemos mudanzas económicas en Pereira sin sacrificar la calidad. Nuestro equipo se encarga de todo: carga, transporte y descarga de tus pertenencias a precios justos.',
      'Nuestras mudanzas y trasteos económicos incluyen personal capacitado, vehículos de carga adecuados y el cuidado que tus muebles y objetos merecen. No importa si es un acarreo pequeño o una mudanza grande, tenemos opciones que se ajustan a tu presupuesto.',
  ...
  },
  {
    ...
    metaDescription: 'Mudanzas pequeñas y acarreos en Pereira. Ideal para mover pocos muebles, electrodomésticos o cajas. Trasteos rápidos. Cotización por WhatsApp.',
    content: [
      '¿Necesitas mover solo unos pocos muebles o electrodomésticos? Nuestro servicio de mudanzas pequeñas y acarreos en Pereira es perfecto para ti. No necesitas contratar un trasteo completo cuando solo tienes unas pocas cosas que trasladar.',
      ...
      'Contáctanos por WhatsApp, cuéntanos qué necesitas mover y te damos una cotización al instante. Acarreos y trasteos rápidos, puntuales y a buen precio.',
    ],
  },
  {
    ...
    metaDescription: 'Mudanzas y trasteos empresariales en Pereira. Trasladamos oficinas, locales comerciales y equipos de trabajo. Acarreos de oficina. Cotización por WhatsApp.',
    content: [
      'Realizamos mudanzas y trasteos empresariales en Pereira con planificación profesional para minimizar el impacto en tu negocio. Trasladamos oficinas completas, locales comerciales, consultorios y espacios de trabajo.',
      'Nuestro equipo maneja con cuidado equipos de cómputo, archivos, mobiliario de oficina y equipos especializados. Coordinamos cada detalle del trasteo para que tu empresa retome operaciones lo antes posible.',
      'Ofrecemos horarios flexibles, incluyendo fines de semana y horarios nocturnos para empresas que no pueden detener operaciones. Solicita tu cotización de mudanza o acarreo por WhatsApp.',
    ],
  },
  {
  ...
  },
  {
    ...
    h1: 'Trasteos en Pereira',
    metaDescription: 'Servicio de trasteos en Pereira y Dosquebradas. Trasteos residenciales, empresariales y acarreos. Cotización rápida y gratis por WhatsApp. Atención 24 horas.',
    content: [
      '¿Buscas un servicio de trasteos en Pereira? Somos expertos en trasteos residenciales, empresariales y acarreos en toda el área de Pereira y Dosquebradas. Un trasteo es el traslado completo de tus pertenencias de un lugar a otro, y nosotros nos encargamos de cada detalle.',
      'Nuestro servicio de trasteos incluye personal capacitado para la carga y descarga, vehículos de diferentes tamaños según tu necesidad, y el cuidado profesional que tus muebles y pertenencias merecen. Ya sea un trasteo de apartamento, casa u oficina, estamos listos.',
      'También hacemos acarreos puntuales si necesitas mover solo algunos objetos. Cubrimos todos los barrios de Pereira y Dosquebradas. Escríbenos por WhatsApp para cotizar tu trasteo sin compromiso.',
    ],
  },
  {
